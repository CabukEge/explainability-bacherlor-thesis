...
def reconstruct_dnf_with_explainer(model: Any, explainer: Any, known_dnf_terms: List) -> str:
    """
    ...
    for test_case in test_cases:
        ...
        # Check if it has 'coefficients' (LIME) or 'shap_values' (SHAP/IG).
    ...
    for name, model in models.items():
        ...
        for explainer_name, explainer in explainers.items():
            ...
            reconstructed_dnf = reconstruct_dnf_with_explainer(
                model, explainer, list(known_dnf_terms)
            )
